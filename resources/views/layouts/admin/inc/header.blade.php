        ...
        <div class="d-flex container-xxl align-items-stretch">
            ...
            <div class="d-flex align-items-center align-items-lg-stretch me-5 flex-row-fluid">
                ...
                <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-center">
                    <img alt="Logo" src="{{ asset('assets2/images/logo/demo20.svg') }}" class="h-25px h-lg-30px" />
                </a>
                <!--end::Logo-->
                <!--begin::Tabs wrapper-->
                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                    ...
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs"
                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_1">Home</a>
                            </li>
                            {{-- @endforeach
                            @endif --}}
                        </ul>
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3"
                        ...
                        <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                            ...
                            <span class="text-white fs-8 fw-bold lh-1">{{ Auth::user()->type }}</span>
                        </div>
                        <!--end::Name-->
                        <!--begin::Symbol-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('assets2/images/blank.png') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('admin.profile') }}" class="menu-link px-5">Account
                                Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                ...
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}"
                        ...
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0"
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <!--begin:Menu link-->
                                    <a class="btn btn-sm btn-light-secondary fw-bold menu-title"
                                    ...
                                    @foreach ($menus as $menu)
                                        <li class="nav-item @if ($loop->index == 0) active @endif">
                                            <a class="nav-link" data-bs-toggle="tab"
                                                href="#kt_header_navs_tab_{{ $menu->slug }}">
                                                {{ $menu->name }}
                                            </a>
                                        </li>
                                    @endforeach
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    ...
                                                    {{-- <a class="menu-link py-3"
                                                        href="/metronic8/demo20/../demo20/apps/calendar.html">
                                                        <span class="menu-title">Calendar</span>
                                                    </a> --}}
                                                    @foreach ($menu->childrens as $children)
                                                        @if (!empty($children->permission->name))
                                                            @can($children->permission->name)
                                                                <a class="menu-link py-3"
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/base/forms/controls.html">Controls</a>
                                <a class="btn btn-sm btn-light-success fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/base/forms/advanced.html">Advanced</a>
                                <a class="btn btn-sm btn-light-danger fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/base/forms/floating-labels.html">Floating
                                    Labels</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-info fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/forms/autosize.html">More
                                    Components</a>
                            </div>
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_3">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/user-management/users/list.html">User
                                    Management</a>
                                <a class="btn btn-sm btn-light-success fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/inbox/listing.html">Inbox</a>
                                <a class="btn btn-sm btn-light-danger fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/file-manager/folders.html">File Manager</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-info fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/subscriptions/view.html">More Apps</a>
                            </div>
                        </div>
                        <!--end::Wrapper-->
                    </div>
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_4">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/ecommerce/catalog/products.html">eCommerce</a>
                                <a class="btn btn-sm btn-light-danger fw-bold"
                                    href="/metronic8/demo20/../demo20/apps/file-manager/folders.html">File Manager</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_5">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                ...
                                <a class="btn btn-sm btn-light-success fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/getting-started/video-tutorials.html">Video
                                    Tutorials</a>
                                <a class="btn btn-sm btn-light-danger fw-bold"
                                    href="/metronic8/demo20/../demo20/layout-builder.html">Layout Builder</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-info fw-bold"
                                    href="/metronic8/demo20/../demo20/documentation/getting-started/changelog.html">Changelog</a>
                            </div>
                        </div>
                        <!--end::Wrapper-->
                    </div>
