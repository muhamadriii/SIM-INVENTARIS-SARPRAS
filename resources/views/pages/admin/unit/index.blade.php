    ...
    <div class="content flex-row-fluid">
        ...
        <div class="card">
            <div class="card-header border-0 pt-6 d-flex justify-content-end">
                <button type="button" class="btn btn-primary btn btn-primary btn-hover-scale" data-bs-toggle="modal" data-bs-target="#unit-modal">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#unit-form').submit(function(e) {
                ...
                const validator = document.getElementById('unit-form').checkValidity()
            ...
            $(document).on('click', '.delete-btn', function(){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const url = '{{ url("admin/unit") }}/' + $(this).data('id')
                        $.ajax({
                            url: url,
                            method: 'DELETE',
                            headers: {
            ...
            $('.modal').on('hidden.bs.modal', function (event) {
                $('#unit-form').attr('action', '{{ route("admin.unit.store") }}')
                method = 'POST'
            })
