                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3 class="card-label">Grafik Penjualan</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <!--begin::Chart-->
                    ...
                    <div class="card h-xl-100">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">Top Product</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">List Top Product</span>
                            </h3>
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Item-->
                            @foreach ($populer_products as $key => $value)
                                    ...
                                    <div class="d-flex align-items-sm-center mb-7">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <span class="symbol-label">
                                                <img src="/metronic8/demo20/assets/media/svg/brand-logos/plur.svg"
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            <div class="flex-grow-1 me-2">
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">{{ $value->product->name }}</a>
                                                @if (!is_null($value->product->category))
                                                    <span
                                                        class="text-muted fw-semibold d-block fs-7">{{ $value->product->category->name }}</span>
                                                @endif

                                            </div>
                                            <!-- <span class="badge badge-light fw-bold my-2">{{ $value->qty }}</span> -->
                                            <span class="badge badge-light fw-bold my-2">Rp.
                                                {{ @number_format($value->product->price) }} </span>
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                @endif
            ...
            <div class="row g-5 g-lg-10">
                ...
                <div class="col-xl-12 mb-5 mb-xl-10">
                    ...
                    <div class="card h-xl-100">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Latest Order</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Order Detail</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                ...
                <div class="col-xl-12 mb-5 mb-xl-10">
                    ...
                    <div class="card h-xl-100">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Structure</span>
                                {{-- <span class="text-muted mt-1 fw-semibold fs-7">Detail</span> --}}
                            </h3>
                            <table class="table table-striped table-hover table-bordered data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Total Member / jenjang</th>
                                        <th>Belanja Perbulan</th>
                                        <th>Omzet</th>
                                        <th>Komisi per level</th>
                                        <th>Total Pembagian Komisi</th>
                                        <th>Asumsi Untung</th>
                                        <th>Asumsi Bersih</th>
                                        <th>Pendapatan Dari ADM</th>
                                        <th>Akumulasi Pendapatan Dari ADM</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data['total_member_by_pack'] }}</td>
                                        <td>{{ $data['total_member_by_level'] }}</td>
                                        <td>{{ $data['monthly_spend'] }}</td>
                                        <td>{{ $data['omzet'] }}</td>
                                        <td>{{ $data['commission'] }}</td>
                                        <td>{{ $data['dividen_commission'] }}</td>
                                        <td>{{ $data['assum_summary_commission'] }}</td>
                                        <td>{{ $data['assum_summary_commission_clean'] }}</td>
                                        <td>{{ $data['adminstration'] }}</td>
                                        <td>{{ $data['sum_adminstration'] }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header border-0 justify-content-end">
                            ...
                            <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"
                                ...
                                aria-label="Edit Event" data-kt-initialized="1">
                            ...
                            <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                ...
                                aria-label="Delete Event" data-kt-initialized="1">
...
@push('scripts')
    ...
    <script>
        ...
        //
        //
        var chart = new ApexCharts(document.querySelector("#grafik_penjualan"), options);
        chart.render();
    </script>
@endpush
