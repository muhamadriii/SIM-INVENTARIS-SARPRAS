...
@endpush
<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="loan-modal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollble">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="loan-form" method="post" action="{{ route('admin.loans.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="mb-5 fv-row">
                            <label for="return_date" class="required form-label">return_date</label>
                            <input type="date" class="form-control form-control-solid" name="return_date"
                                placeholder="return_date" required />
                        </div>
