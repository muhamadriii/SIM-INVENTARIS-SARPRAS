...
class OrdersDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('image', function($query) {
                if ($query->image == null) {
                    ...
                    return '<img src="'. asset('storage/orders'). '/'. $query->image .'" class="img-fluid rounded image-modal" style="height:50px;">';
                }
            })
    ...
    {
        return $model->select('members.name as members.name', 'orders.*')
